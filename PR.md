...
files_changed:
  - ".agent/skills/k8s-review/SKILL.md"
...
Our review agent already reads `.agent/skills/` (see the platform team's
...
This PR adds `.agent/skills/k8s-review/SKILL.md` with a review procedure
